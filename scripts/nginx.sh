...
FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS="brain"
...
sudo cp "/home/ubuntu/$MAIN_DIR_NAME/nginx/nginx.conf" "/etc/nginx/sites-available/$FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS"
